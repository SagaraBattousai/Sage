...
class Shader private constructor(private val program: Int) {
    ...
    //TODO(): Add @Inject
    class Builder(private val resourcer: Resourcer<String>) {

        private val shaderResourceIDs: MutableSet<Pair<Int, Int>> = HashSet()

        fun withVertexShader(vertexShaderResourceID: Int): Builder =
            apply {
                shaderResourceIDs.add(Pair(GLES30.GL_VERTEX_SHADER, vertexShaderResourceID))
            }

        fun withFragmentShader(fragmentShaderResourceID: Int): Builder =
            apply {
